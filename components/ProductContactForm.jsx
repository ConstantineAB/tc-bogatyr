...
function ProductContactForm({ id, name, type, size, totalPrice, totalCount, onRemove, onMinus, onPlus, img }) {
	...
	<div className="cart__item">
		<div className="cart__item-img">
			...
			<div className="cart__item-info">
					...
					<p>Имя</p>
					<input type='text' value={type} onChange={event => setName(event.target.value)}/>
					<p>Имя</p>
					<input type='text' value={size} onChange={event => setName(event.target.value)}/>
			</div>
